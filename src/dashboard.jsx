            ...
            try {
                ...
                if (email && latestImageData) {
                    ...
                    if (evacuationMode && currentCount > 0) {
                        console.log("Evacuation email triggered! Sending email...");
                ...
                <div className="container flex justify-center min-w-full mx-auto p-20 grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6 bg-white">
                    ...
                    <div className="p-4 rounded-lg shadow-md col-span-1 bg-white">
                        ...
                        <div className="flex items-center">
                            ...
                            <input type="checkbox" checked={evacuationMode} onChange={() => setEvacuationMode(!evacuationMode) & emailNotification()} className="toggle" />
                        </div>
                    </div>
                    {!evacuationMode ? (
                        <div className="p-4 rounded-lg shadow-md col-span-1 bg-white">
